...
exports.genericHEAD = genericHEAD;
exports.genericOPTIONS = genericOPTIONS;
exports.reqCheckMethods = reqCheckMethods;
exports.reqContentCheck = reqContentCheck;
exports.reqAcceptCheck = reqAcceptCheck;
exports.reqBodyObjectCheck = reqBodyObjectCheck;
exports.reqBodyPropertyCheck = reqBodyPropertyCheck;
exports.resGetUsers = resGetUsers;
exports.resGetMessages = resGetMessages;
exports.resGetLogs = resGetLogs;
exports.resGetUserByName = resGetUserByName;
exports.resGetMessageByRefId = resGetMessageByRefId;
exports.resGetLogByName = resGetLogByName;
...
function resGetUsers(req, res, next) {
  db.getUsers(function (err, usersRes) {
    if (err) {
...
function resGetMessages(req, res, next) {
  db.getMessages(function (err, msgsRes) {
    if (err) {
      customError(500, res.locals.methodsString, next);
    } else {
...
function resGetLogs(req, res, next) {
  db.getLogs(function (err, logsRes) {
    if (err) {
      customError(500, res.locals.methodsString, next);
    } else {
...
function resGetUserByName(name, req, res, next) {
  db.getUserByName(name, function (err1, userRes) {
    if (err1) {
...
function resGetMessageByRefId(refId, req, res, next) {
  db.getMessageByRefId(refId, function (err, message) {
    if (err) {
...
function resGetLogByName(name, req, res, next) {
  db.getLogByName(name, function (err1, logRes) {
    if (err1) {
